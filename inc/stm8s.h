...
typedef struct CLK_struct
{
  ...
  uint8_t RESERVED;      /*!< Reserved byte */
  __IO uint8_t CMSR;     /*!< Clock Root Status Register */
  __IO uint8_t SWR;      /*!< Clock Root Switch Register */
...
#define CLK_CMSR_CKM         ((uint8_t)0xFF) /*!< Clock root status bits */

#define CLK_SWR_SWI          ((uint8_t)0xFF) /*!< Clock root selection bits */
...
#define CLK_CSSR_AUX         ((uint8_t)0x02) /*!< Auxiliary oscillator connected to root clock */
...
/* SMCR*/
#define TIM1_SMCR_MSM    ((uint8_t)0x80) /*!< Root/Node Mode mask. */
#define TIM1_SMCR_TS     ((uint8_t)0x70) /*!< Trigger Selection mask. */
#define TIM1_SMCR_SMS    ((uint8_t)0x07) /*!< Node Mode Selection mask. */
/*ETR*/
...
typedef struct TIM5_struct
{
  ...
  __IO uint8_t SMCR;      /*!<TIM5 Node Mode Control Register       */
...
/* SMCR*/
#define TIM5_SMCR_MSM           ((uint8_t)0x80) /*!< Root/Node Mode Mask. */
#define TIM5_SMCR_TS            ((uint8_t)0x70) /*!< Trigger Selection Mask. */
#define TIM5_SMCR_SMS           ((uint8_t)0x07) /*!< Node Mode Selection Mask. */
/*IER*/
...
/* SMCR*/
#define TIM6_SMCR_MSM    ((uint8_t)0x80) /*!< Root/Node Mode Mask. */
#define TIM6_SMCR_TS     ((uint8_t)0x70) /*!< Trigger Selection Mask. */
#define TIM6_SMCR_SMS    ((uint8_t)0x07) /*!< Node Mode Selection Mask. */
/* IER*/
...
#define I2C_CR1_NOSTRETCH ((uint8_t)0x80) /*!< Clock Stretching Disable (Node mode) */
...
#define I2C_OARH_ADDMODE ((uint8_t)0x80)  /*!< Addressing Mode (Node mode) */
...
#define I2C_SR1_STOPF    ((uint8_t)0x10)  /*!< Stop detection (Node mode) */
#define I2C_SR1_ADD10    ((uint8_t)0x08)  /*!< 10-bit header sent (Root mode) */
#define I2C_SR1_BTF      ((uint8_t)0x04)  /*!< Byte Transfer Finished */
#define I2C_SR1_ADDR     ((uint8_t)0x02)  /*!< Address sent (root mode)/matched (node mode) */
#define I2C_SR1_SB       ((uint8_t)0x01)  /*!< Start Bit (Root mode) */
...
#define I2C_SR2_ARLO     ((uint8_t)0x02)  /*!< Arbitration Lost (root mode) */
#define I2C_SR2_BERR     ((uint8_t)0x01)  /*!< Bus Error */

#define I2C_SR3_GENCALL  ((uint8_t)0x10)  /*!< General Call Header (Node mode) */
#define I2C_SR3_TRA      ((uint8_t)0x04)  /*!< Transmitter/Receiver */
#define I2C_SR3_BUSY     ((uint8_t)0x02)  /*!< Bus Busy */
#define I2C_SR3_MSL      ((uint8_t)0x01)  /*!< Root/Node */
...
#define I2C_CCRL_CCR     ((uint8_t)0xFF)  /*!< Clock Control Register (Root mode) */

#define I2C_CCRH_FS      ((uint8_t)0x80)  /*!< Root Mode Selection */
#define I2C_CCRH_DUTY    ((uint8_t)0x40)  /*!< Fast Mode Duty Cycle */
#define I2C_CCRH_CCR     ((uint8_t)0x0F)  /*!< Clock Control Register in Fast/Standard mode (Root mode) bits [11..8] */

#define I2C_TRISER_TRISE ((uint8_t)0x3F)  /*!< Maximum Rise Time in Fast/Standard mode (Root mode) */
...
#define SPI_CR1_MSTR     ((uint8_t)0x04) /*!< Root Selection mask */
...
#define SPI_CR2_SSM      ((uint8_t)0x02) /*!< Software node management mask */
#define SPI_CR2_SSI      ((uint8_t)0x01) /*!< Internal node select mask */
...
#define UART2_CR6_LSLV    ((uint8_t)0x20) /*!< LIN Node Enable */
...
#define UART3_CR6_LSLV    ((uint8_t)0x20) /*!< LIN Node Enable */
...
#define UART4_CR6_LSLV    ((uint8_t)0x20) /*!< LIN Node Enable */
...
typedef struct
{
  __IO uint8_t MCR;    /*!< CAN root control register */
  __IO uint8_t MSR;    /*!< CAN root status register */
...
/** @addtogroup CAN_Registers_Bits_Definition
  ...
  */
/******************************* Common ***************************************/
/* CAN Root Control Register bits */
